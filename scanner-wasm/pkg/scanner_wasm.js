/* @ts-self-types="./scanner_wasm.d.ts" */
 ...
 */
export function decode_rgba(width, height, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.decode_rgba(retptr, width, height, ptr0, len0);
 ...
 * @returns {string | undefined}
 */
export function decode_rgba_hard(width, height, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.decode_rgba_hard(retptr, width, height, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        let v2;
        if (r0 !== 0) {
 ...
 * @returns {Uint8Array}
 */
export function encode_test_rgba(format, text, width, height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.encode_test_rgba(retptr, ptr0, len0, ptr1, len1, width, height);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('scanner_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
